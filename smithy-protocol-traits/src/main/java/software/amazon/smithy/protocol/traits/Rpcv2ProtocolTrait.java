...
/**
 * Represents a configurable RPC v2 protocol trait.
 */
abstract class Rpcv2ProtocolTrait extends AbstractTrait {
    ...
    Rpcv2ProtocolTrait(ShapeId id, Builder<?, ?> builder) {
    ...
    /**
     * Builder for creating an {@code Rpcv2ProtocolTrait}.
     *
     * @param <T> The type of trait being created.
     * @param <B> The concrete builder that creates {@code T}.
     */
    abstract static class Builder<T extends Trait, B extends Builder<T, B>>
