...
# source/ to match, and references to the director in source/index.rst.
# *********************************************************************
release = u'1.0.0'   # The full version of the spec (e.g., "1.0.0")
version = '.'.join(release.split('.')[0:2])   # The short X.Y version (e.g., "1.0")
