...
.. code-block:: kotlin
    ...
    buildscript {
        dependencies {
            classpath("software.amazon.smithy:smithy-openapi:0.9.6")
        }
    }
...
.. important::
    ...
    A buildscript dependency on "software.amazon.smithy:smithy-openapi:0.9.6" is
...
.. code-block:: kotlin
    ...
    buildscript {
        dependencies {
            classpath("software.amazon.smithy:smithy-aws-apigateway-openapi:0.9.6")
        }
    }
