...
shows you how to implement flexible endpoint resolution that can handle
...
It is recommended to make the endpoint resolver params a separate object so that
they may be constructed and passed around more simply. They should include
