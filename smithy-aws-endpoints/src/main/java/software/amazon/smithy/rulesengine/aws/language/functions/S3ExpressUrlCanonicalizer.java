 ...
 * </ul>
 *
 * <p>This class is not thread-safe and instances should not be shared.
 */
@SmithyInternalApi
public final class S3ExpressUrlCanonicalizer {
     ...
     */
    public static boolean isS3ExpressUrl(String url) {
     ...
     */
    public static CanonicalizedUrl canonicalize(String url) {
        if (url == null) {
            return null;
        }
     ...
     */
    public static final class CanonicalizedUrl {
         ...
         *
         * <p>The result URL contains {@code {_s3e_fips}} and {@code {_s3e_ds}} template
         * references that will be resolved at runtime based on the ITE conditions
         * injected by S3TreeRewriter.
         *
