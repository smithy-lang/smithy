...
apply ExactDocumentInQuery @httpRequestTests([
    {
        ...
        params: {
            documentValue: "{\"greeting\": \"hello\"}",
            // Not valid binary Ion, but that's not the point of this test.
            // Blobs are base64 encoded and the percent-encoded when placed in the
            // query string.
            ionValue: "{}",
        }
    }
...
apply ExactBlobDocumentAsPayload @httpRequestTests([
    {
        ...
        headers: {
            ...
            "Content-Type": "application/x-amzn-ion"
        },
        body: "{}",
        bodyMediaType: "application/json",
        params: {
