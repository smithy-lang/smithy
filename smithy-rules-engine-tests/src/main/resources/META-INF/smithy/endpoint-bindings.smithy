    ...
    testCases: [
        {
            ...
            params: { Endpoint: "https://custom-endpoint.com" }
            expect: {
            ...
            operationInputs: [
                {
                    ...
                    builtInParams: { "SDK::Endpoint": "https://custom-endpoint.com" }
                }
            ]
        }
        {
        ...
        }
        {
            ...
            params: { baz: "client-config" }
            expect: {
                endpoint: { url: "https://client-config/set" }
            }
            operationInputs: [
                {
                    operationName: "NoBindingsOperation"
                    clientParams: { baz: "client-config" }
                }
            ]
        }
        {
            documentation: "StaticContextParam values used"
            params: { bar: "static-context", booleanParam: false }
            expect: {
                endpoint: { url: "https://static-context.baz/unset" }
            }
            operationInputs: [
                {
        ...
        }
        {
            ...
            params: { bar: "context-bar", baz: "context-baz", booleanParam: false }
            expect: {
                endpoint: { url: "https://context-bar.context-baz/unset" }
            }
            operationInputs: [
                {
                    operationName: "ContextParamsOperation"
                    operationParams: { bar: "context-bar", baz: "context-baz", booleanParam: false }
                    clientParams: { bar: "client-config" }
                }
            ]
        }
        {
            documentation: "OperationContextParam values used over config and defaults"
            params: { bar: "operation-context-bar", baz: "operation-context-baz", booleanParam: false }
            expect: {
                endpoint: { url: "https://operation-context-bar.operation-context-baz/unset" }
            }
            operationInputs: [
                {
                    operationName: "OperationContextParamsOperation"
                    operationParams: {
                        nested: { bar: "operation-context-bar", baz: "operation-context-baz" }
                        booleanParam: false
                    }
                    clientParams: { bar: "client-config" }
                }
