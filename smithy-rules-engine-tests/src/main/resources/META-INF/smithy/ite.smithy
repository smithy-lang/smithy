...
@endpointRuleSet({
    version: "1.1"
    parameters: {
        useFips: { type: "boolean", documentation: "Use FIPS endpoints", default: false, required: true }
    }
    rules: [
        {
            ...
            endpoint: { url: "https://example{suffix}.com" }
            type: "endpoint"
        }
    ]
})
    ...
    testCases: [
        {
            ...
            expect: {
                endpoint: { url: "https://example-fips.com" }
            }
        }
        {
