...
public class ParserTest {
    ...
    public void parsesFunctionExpression() {
        assertThat(
            JmespathExpression.parse("length(@)"),
            equalTo(
    ...
    public void parsesFunctionWithMultipleArguments() {
        assertThat(
            JmespathExpression.parse("starts_with(@, 'foo')"),
            equalTo(
    ...
    public void parsesNudMultiSelectList() {
        assertThat(
            JmespathExpression.parse("[foo, bar]"),
            equalTo(
    ...
    public void parsesNudMultiSelectHash() {
        ...
        assertThat(
            JmespathExpression.parse("{foo: bar, baz: bam.boo}"),
            equalTo(
    ...
    public void parsesNudAmpersand() {
        assertThat(
            JmespathExpression.parse("&foo[1]"),
            equalTo(
    ...
    public void parsesNudFilter() {
        assertThat(
            JmespathExpression.parse("[?foo == `true`]"),
            equalTo(
    ...
    public void parsesNudFilterWithComparators() {
        for (ComparatorType type : ComparatorType.values()) {
            assertThat(
                JmespathExpression.parse("[?foo " + type + " `true`]"),
                equalTo(
                    new FilterProjectionExpression(
                        new CurrentExpression(),
                        new ComparatorExpression(
    ...
    public void parsesSubexpressions() {
        assertThat(
            JmespathExpression.parse("foo.bar.baz"),
            equalTo(
                new Subexpression(
                    new Subexpression(
                        new FieldExpression("foo"),
    ...
    public void parsesLedFilterProjection() {
        assertThat(
            JmespathExpression.parse("a[?b > c].d"),
            equalTo(
                new FilterProjectionExpression(
    ...
    public void parsesLedProjectionIntoIndex() {
        assertThat(
            JmespathExpression.parse("a.*[1].b"),
            equalTo(
                new ObjectProjectionExpression(
                    new FieldExpression("a"),
                    new Subexpression(
    ...
    public void parsesLedProjectionIntoFilterProjection() {
        assertThat(
            JmespathExpression.parse("a.*[?foo == bar]"),
            equalTo(
                new ObjectProjectionExpression(
                    new FieldExpression("a"),
                    new FilterProjectionExpression(
    ...
    public void parsesSlices() {
        assertThat(
            JmespathExpression.parse("[1:3].foo"),
            equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithStep() {
        assertThat(
            JmespathExpression.parse("[5:10:2]"),
            equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithNegativeStep() {
        assertThat(
            JmespathExpression.parse("[10:5:-1]"),
            equalTo(
                new ProjectionExpression(
