...
public class ParserTest {
    ...
    public void throwsOnInvalidNudToken() {
        JmespathException e = Assertions.assertThrows(
                JmespathException.class,() -> JmespathExpression.parse("|| a"));
    ...
    public void parsesFunctionExpression() {
        assertThat(JmespathExpression.parse("length(@)"), equalTo(
    ...
    public void parsesFunctionWithMultipleArguments() {
        assertThat(JmespathExpression.parse("starts_with(@, 'foo')"), equalTo(
                new FunctionExpression("starts_with", Arrays.asList(
    ...
    public void detectsIllegalTrailingCommaInFunctionExpression() {
        JmespathException e = Assertions.assertThrows(
                JmespathException.class, () -> JmespathExpression.parse("lenght(@,)"));
    ...
    public void parsesNudWildcardIndex() {
        assertThat(JmespathExpression.parse("[*]"), equalTo(
    ...
    public void parsesNudFlatten() {
        assertThat(JmespathExpression.parse("[].foo"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesNudMultiSelectList() {
        assertThat(JmespathExpression.parse("[foo, bar]"), equalTo(
    ...
    public void detectsIllegalTrailingCommaInNudMultiSelectList() {
        JmespathException e = Assertions.assertThrows(
                JmespathException.class, () -> JmespathExpression.parse("[foo,]"));
    ...
    public void parsesNudMultiSelectHash() {
        ...
        assertThat(JmespathExpression.parse("{foo: bar, baz: bam.boo}"), equalTo(
    ...
    public void parsesSubexpressions() {
        assertThat(JmespathExpression.parse("foo.bar.baz"), equalTo(
                new Subexpression(
                        new Subexpression(
                                new FieldExpression("foo"),
                                new FieldExpression("bar")),
    ...
    public void parsesLedFlattenProjection() {
        assertThat(JmespathExpression.parse("a[].b"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesLedProjectionIntoIndex() {
        assertThat(JmespathExpression.parse("a.*[1].b"), equalTo(
                new ObjectProjectionExpression(
                        new FieldExpression("a"),
                        new Subexpression(
                                new IndexExpression(1),
    ...
    public void parsesLedProjectionIntoFilterProjection() {
        assertThat(JmespathExpression.parse("a.*[?foo == bar]"), equalTo(
                new ObjectProjectionExpression(
                        new FieldExpression("a"),
                        new FilterProjectionExpression(
                                new CurrentExpression(),
    ...
    public void parsesSlices() {
        assertThat(JmespathExpression.parse("[1:3].foo"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithStep() {
        assertThat(JmespathExpression.parse("[5:10:2]"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithNegativeStep() {
        assertThat(JmespathExpression.parse("[10:5:-1]"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithStepAndNoStop() {
        assertThat(JmespathExpression.parse("[10::5]"), equalTo(
                new ProjectionExpression(
    ...
    public void parsesSlicesWithStartAndNoStepOrEnd() {
        assertThat(JmespathExpression.parse("[10::]"), equalTo(
                new ProjectionExpression(
