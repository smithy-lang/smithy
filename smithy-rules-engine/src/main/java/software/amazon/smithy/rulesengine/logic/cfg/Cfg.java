...
public final class Cfg implements Iterable<CfgNode> {
    ...
    /**
     * @param ruleSet the rule set this CFG was built from
     * @param root the root node of the control flow graph
     */
    public Cfg(EndpointRuleSet ruleSet, CfgNode root) {
    ...
    private static Cfg convert(EndpointRuleSet ruleSet) {
