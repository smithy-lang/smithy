...
public final class FunctionNode implements FromSourceLocation, ToNode, ToSmithyBuilder<FunctionNode> {
    ...
    public Node toNode() {
        ...
        ArrayNode argumentsNode = arguments.stream().map(ToNode::toNode).collect(ArrayNode.collect());
        node.withMember(ARGV, argumentsNode);
    ...
    public static final class Builder extends SourceLocationTrackingBuilder<Builder, FunctionNode> {
