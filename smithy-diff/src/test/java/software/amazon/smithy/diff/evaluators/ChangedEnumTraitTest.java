...
public class ChangedEnumTraitTest {
    ...
    public void detectsAppendedEnums() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended")
                .stream()
                .allMatch(e -> e.getSeverity() == Severity.NOTE),
            equalTo(true)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended")
                .stream()
                .allMatch(e -> source.equals(e.getSourceLocation())),
            equalTo(true)
        );
    }
    ...
    public void detectsAppendedEnumsEnumTraitNoNameToEnumShape() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.NameChanged.0").get(0).getSeverity(),
            equalTo(Severity.ERROR)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.NameChanged.0").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended.1").get(0).getSeverity(),
            equalTo(Severity.NOTE)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended.1").get(0).getSourceLocation(),
            equalTo(source)
        );
    }
    ...
    public void detectsAppendedEnumsEnumTraitWithNameToEnumShape() {
        ...
        assertThat(TestHelper.findEvents(events, "ChangedEnumTrait.Appended.1").size(), equalTo(1));
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended")
    ...
    public void detectsRemovedEnums() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Removed.1").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(TestHelper.findEvents(events, "ChangedEnumTrait.Removed.2").size(), equalTo(1));
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Removed.2").get(0).getSourceLocation(),
            equalTo(source)
        );
    ...
    public void detectsRemovedEnumsEnumTraitNoNameToEnumShape() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait")
                .stream()
                .allMatch(e -> e.getSeverity() == Severity.ERROR),
            equalTo(true)
        );
    }
    ...
    public void detectsRemovedEnumsEnumTraitWithNameToEnumShape() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Removed.1")
                .stream()
                .allMatch(e -> e.getSeverity() == Severity.ERROR),
            equalTo(true)
        );
    ...
    public void detectsRenamedEnums() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.NameChanged.1").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(TestHelper.findEvents(events, Severity.ERROR).size(), equalTo(2));
    }
    ...
    public void detectsInsertedEnums() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.0").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.1").size(), equalTo(1));
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.1").get(0).getSourceLocation(),
            equalTo(source)
        );
        assertThat(TestHelper.findEvents(events, Severity.ERROR).size(), equalTo(2));
    }
    ...
    public void detectsInsertedEnumsBeforeAppendedEnums() {
        ...
        assertThat(TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.0").size(), equalTo(1));
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.0")
                .get(0)
                .getSourceLocation(),
            equalTo(source)
        );
        assertThat(TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.1").size(), equalTo(1));
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.OrderChanged.1")
                .get(0)
                .getSourceLocation(),
            equalTo(source)
        );
    ...
    public void detectsAppendedEnumsAfterRemovedEnumsEnumTraitNoNameToEnumShape() {
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.NameChanged.2").get(0).getSourceLocation(),
            equalTo(afterSource)
        );
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait")
        ...
        assertThat(
            TestHelper.findEvents(events, "ChangedEnumTrait.Appended.2")
                .stream()
                .allMatch(e -> e.getSeverity() == Severity.NOTE),
            equalTo(true)
        );
