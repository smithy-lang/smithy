...
public final class Schema implements ToNode, ToSmithyBuilder<Schema> {
    ...
    public static final class Builder implements SmithyBuilder<Schema> {
        ...
        private BuilderRef<List<String>> required = BuilderRef.forList();
        private BuilderRef<Map<String, Schema>> properties = BuilderRef.forOrderedMap();
        private Schema additionalProperties;
        private Schema propertyNames;
        private BuilderRef<Map<String, Schema>> patternProperties = BuilderRef.forOrderedMap();

        private BuilderRef<List<Schema>> allOf = BuilderRef.forList();
        private BuilderRef<List<Schema>> anyOf = BuilderRef.forList();
        private BuilderRef<List<Schema>> oneOf = BuilderRef.forList();
        private Schema not;
