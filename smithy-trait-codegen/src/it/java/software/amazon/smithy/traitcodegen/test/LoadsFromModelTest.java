...
public class LoadsFromModelTest {
    ...
    static Stream<Arguments> loadsModelTests() {
        return Stream.of(
            ...
            Arguments.of(
                "structures/struct-trait.smithy",
            ...
            Arguments.of(
                "structures/struct-with-non-existent-collections.smithy",
                StructureTrait.class,
                MapUtils.of(
                    "getFieldA",
                    "first",
            ...
            // Timestamps
            Arguments.of(
                "timestamps/struct-with-nested-timestamps.smithy",
                ...
                MapUtils.of(
                    ...
                    Instant.parse("1985-04-12T23:20:50.52Z"),
                    "getHttpDate",
                    Instant.from(DateTimeFormatter.RFC_1123_DATE_TIME.parse("Tue, 29 Apr 2014 18:30:38 GMT")),
                    "getEpochSeconds",
            ...
            Arguments.of(
                "timestamps/timestamp-trait-epoch-sec.smithy",
                TimestampTrait.class,
            ...
            // Uniques items (sets)
            Arguments.of(
                "uniqueitems/number-set-trait.smithy",
