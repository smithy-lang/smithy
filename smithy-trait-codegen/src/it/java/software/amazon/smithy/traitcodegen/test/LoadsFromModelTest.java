...
public class LoadsFromModelTest {
    ...
    static Stream<Arguments> loadsModelTests() {
        return Stream.of(
                ...
                Arguments.of("defaults/defaults.smithy",
                        StructDefaultsTrait.class,
                        MapUtils.of("getDefaultString", "default with special $ symbol")),
                Arguments.of("defaults/defaults.smithy",
                        StructDefaultsTrait.class,
                        MapUtils.of("getDefaultStringSugar", "default with special $ symbol")),
                Arguments.of("defaults/defaults.smithy",
                        StructDefaultsTrait.class,
                        MapUtils.of("getDefaultStringIdRef", "test.smithy.traitcodegen.defaults#Enum$FOO")),
                Arguments.of("defaults/defaults.smithy",
                        StructDefaultsTrait.class,
