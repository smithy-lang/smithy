...
public class CreatesTraitTest {
    ...
    static Stream<Arguments> createTraitTests() {
        return Stream.of(
            ...
            Arguments.of(
                StructWithNestedDocumentTrait.ID,
