...
final class ProviderGenerator implements Runnable {
    ...
    private final class ProviderMethodVisitor extends TraitVisitor<Void> {
        ...
        public Void documentShape(DocumentShape shape) {
            writer.openBlock(
                "public static final class Provider extends $T.Provider {",
                "}",
                AbstractTrait.class,
                () -> {
                    ...
                    writer.override();
                    writer.openBlock(
                        "public $T createTrait($T target, $T value) {",
                        "}",
                        Trait.class,
                        ShapeId.class,
                        Node.class,
        ...
        public Void listShape(ListShape shape) {
            ...
            if (TraitCodegenUtils.isJavaStringList(shape, provider)) {
                writer.openBlock(
                    "public static final class Provider extends $T.Provider<$T> {",
                    "}",
            ...
            writer.openBlock(
                ...
                () -> {
                    ...
                    writer.openBlock(
                        ...
                        Node.class,
                        () -> writer.write(
                            "return new $1T($2C, value.getSourceLocation());",
                            traitSymbol,
