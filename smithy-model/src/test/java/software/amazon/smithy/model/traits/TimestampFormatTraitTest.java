...
public class TimestampFormatTraitTest {
    ...
    public void createsFromString() {
        assertThat(
            TimestampFormatTrait.Format.fromString("date-time"),
            equalTo(TimestampFormatTrait.Format.DATE_TIME)
        );
        assertThat(
            TimestampFormatTrait.Format.fromString("http-date"),
            equalTo(TimestampFormatTrait.Format.HTTP_DATE)
        );
        assertThat(
            TimestampFormatTrait.Format.fromString("epoch-seconds"),
            equalTo(TimestampFormatTrait.Format.EPOCH_SECONDS)
        );
        assertThat(
            TimestampFormatTrait.Format.fromString("foo-baz"),
    ...
    public void convertsFormatToString() {
        assertThat(
            TimestampFormatTrait.Format.fromString("date-time").toString(),
            equalTo("date-time")
        );
    }
