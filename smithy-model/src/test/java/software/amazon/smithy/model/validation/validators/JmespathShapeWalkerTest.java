...
public class JmespathShapeWalkerTest {
    ...
    public void walksFieldChain() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("spec.size"));
    ...
    public void walksProjectionToLeaf() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("items[*].id"));
        assertThat(r.error, is(nullValue()));
    ...
    public void walksProjectionToElementStructure() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("items[*]"));
        assertThat(r.error, is(nullValue()));
        assertThat(r.arrayDepth, is(1));
    ...
    public void walksCurrentNodeAsRoot() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("@"));
        assertThat(r.error, is(nullValue()));
    ...
    public void errorsOnMissingMember() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("nope"));
    ...
    public void sameListSharesSignature() {
        Model model = model();
        JmespathPathResult id = JmespathShapeWalker.walk(model,
                struct(model, "In"),
                JmespathExpression.parse("items[*].id"));
        JmespathPathResult tag = JmespathShapeWalker.walk(model,
                struct(model, "In"),
    ...
    public void nestedProjectionsAccumulateSignatureInOrder() {
        Model model = model();
        JmespathPathResult r = JmespathShapeWalker.walk(model,
                struct(model, "In"),
    ...
    public void scalarFieldHasEmptySignature() {
        Model model = model();
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("name"));
        assertThat(r.error, is(nullValue()));
    ...
    public void fieldAccessOnMapResolvesToValueType() {
        ...
        JmespathPathResult r =
                JmespathShapeWalker.walk(model, struct(model, "In"), JmespathExpression.parse("byId.anyKey"));
        assertThat(r.error, is(nullValue()));
        assertThat(r.leaf.getId(), is(ShapeId.from("com.test#Item")));
        assertThat(r.arrays.isEmpty(), is(true));
    }
