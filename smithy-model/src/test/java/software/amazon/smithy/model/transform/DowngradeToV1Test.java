...
public class DowngradeToV1Test {
    ...
    public void removesResourceProperties() {
        ...
        assertThat(
            downgraded.expectShape(resource.getId(), ResourceShape.class).getProperties(),
            Matchers.anEmptyMap()
        );

        assertThat(
            downgraded.expectShape(input.getMember("foo").get().getId()).hasTrait(PropertyTrait.class),
            Matchers.is(false)
        );
        assertThat(
            downgraded.expectShape(input.getMember("baz").get().getId()).hasTrait(NotPropertyTrait.class),
            Matchers.is(false)
        );
    }
    ...
    public void removesUnnecessaryDefaults() {
        ...
        assertThat(
            downgraded.expectShape(zeroIntegerShape)
        ...
        assertThat(
            dStruct.getAllMembers().get("zeroTargetZeroMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        ...
        // A Member that has a default value of null keeps the default value of null and is boxed
        assertThat(
            dStruct.getAllMembers().get("zeroTargetBoxedMember").hasTrait(DefaultTrait.class),
            Matchers.is(true)
        );
        assertThat(
            dStruct.getAllMembers().get("zeroTargetBoxedMember").expectTrait(DefaultTrait.class).toNode().isNullNode(),
            Matchers.is(true)
        );
        assertThat(
            dStruct.getAllMembers().get("zeroTargetBoxedMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        ...
        // A Member that has a target shape with no default value drops the default value
        assertThat(
            dStruct.getAllMembers().get("boxedTargetZeroMember").hasTrait(DefaultTrait.class),
            Matchers.is(false)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetZeroMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        ...
        // A Member that has a target shape with no default value drops the default value
        assertThat(
            dStruct.getAllMembers().get("boxedTargetNonzeroMember").hasTrait(DefaultTrait.class),
            Matchers.is(false)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetNonzeroMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetNonzeroMember").hasTrait(BoxTrait.class),
            Matchers.is(false)
        );

        // A Member that has a default value of null keeps the default value of null and is boxed
        assertThat(
            dStruct.getAllMembers().get("boxedTargetBoxedMember").hasTrait(DefaultTrait.class),
            Matchers.is(true)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetBoxedMember").expectTrait(DefaultTrait.class).toNode().isNullNode(),
            Matchers.is(true)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetBoxedMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        ...
        // A Member that has no default value has no default trait and the member is not boxed
        assertThat(
            dStruct.getAllMembers().get("boxedTargetImplicitBoxedMember").hasTrait(DefaultTrait.class),
            Matchers.is(false)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetImplicitBoxedMember").hasTrait(AddedDefaultTrait.class),
            Matchers.is(false)
        );
        assertThat(
            dStruct.getAllMembers().get("boxedTargetImplicitBoxedMember").hasTrait(BoxTrait.class),
            Matchers.is(false)
        );
        ...
        assertThat(
            dStruct.getAllMembers().get("baz").expectTrait(DefaultTrait.class).toNode().isNullNode(),
            Matchers.is(true)
        );
