...
public class BottomUpIndexTest {
    ...
    public void findsEntityBinding() {
        ...
        assertThat(
            index.getEntityBinding(serviceId, ShapeId.from("smithy.example#ServiceOperation")).map(EntityShape::getId),
            equalTo(Optional.of(serviceId))
        );
        assertThat(
            index.getEntityBinding(serviceId, ShapeId.from("smithy.example#Resource1")).map(EntityShape::getId),
            equalTo(Optional.of(serviceId))
        );
        assertThat(
    ...
    public void findsResourceBinding() {
        ...
        assertThat(
            index.getResourceBinding(serviceId, ShapeId.from("smithy.example#Resource1_1_1")).map(EntityShape::getId),
            equalTo(Optional.of(ShapeId.from("smithy.example#Resource1_1")))
        );
        assertThat(
            index.getResourceBinding(serviceId, ShapeId.from("smithy.example#Resource1_1_2")).map(EntityShape::getId),
            equalTo(Optional.of(ShapeId.from("smithy.example#Resource1_1")))
        );
        assertThat(
            index.getResourceBinding(serviceId, ShapeId.from("smithy.example#Resource1_1_Operation"))
