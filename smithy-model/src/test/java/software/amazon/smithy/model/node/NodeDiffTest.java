...
public class NodeDiffTest {
    ...
    public void detectsNodeTypeDifference() {
        assertThat(
            NodeDiff.diff(Node.nullNode(), Node.from(true)),
            contains(
                String.format(
    ...
    public void comparesBooleans() {
        ...
        assertThat(
            NodeDiff.diff(Node.from(true), Node.from(false)),
    ...
    public void comparesNumbers() {
        ...
        assertThat(
            NodeDiff.diff(Node.from(2), Node.from(1)),
    ...
    public void comparesStrings() {
        ...
        assertThat(
            NodeDiff.diff(Node.from("foo"), Node.from("bar")),
