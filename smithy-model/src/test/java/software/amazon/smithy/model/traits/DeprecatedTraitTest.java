...
public class DeprecatedTraitTest {
    ...
    public void returnDefaultDescription() {
        ...
        assertThat(
            deprecatedTrait.getDeprecatedDescription(ShapeType.OPERATION),
    ...
    public void returnDescriptionWhenMessageSet() {
        ...
        assertThat(
            deprecatedTrait.getDeprecatedDescription(ShapeType.STRING),
    ...
    public void returnDescriptionWhenBothSinceAndMessageSet() {
        DeprecatedTrait deprecatedTrait = DeprecatedTrait.builder()
            .since("2020-01-01")
