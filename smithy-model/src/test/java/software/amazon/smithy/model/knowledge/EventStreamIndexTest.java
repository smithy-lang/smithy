...
public class EventStreamIndexTest {
    ...
    public void providesEmptyOptionalWhenNoInput() {
        ...
        assertThat(
            index.getInputInfo(ShapeId.from("example.smithy#EmptyOperation")),
    ...
    public void providesEmptyOptionalWhenNoOutput() {
        ...
        assertThat(
            index.getOutputInfo(ShapeId.from("example.smithy#EmptyOperation")),
            equalTo(Optional.empty())
        );
    }
    ...
    public void providesEmptyOptionalWhenNoEventStreamTarget() {
        ...
        assertThat(
            index.getOutputInfo(ShapeId.from("example.smithy#NotEventStreamOperation")),
            equalTo(Optional.empty())
        );
    }
    ...
    public void returnsEventStreamOutputInformation() {
        ...
        EventStreamInfo input = index.getInputInfo(
            ShapeId.from("example.smithy#EventStreamOperation")
        ).get();
        ...
        assertThat(
            input.getEventStreamMember().getId(),
        ...
        assertThat(
            output.getEventStreamMember().getId(),
