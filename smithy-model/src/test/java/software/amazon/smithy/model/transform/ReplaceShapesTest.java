...
public class ReplaceShapesTest {
    ...
    public void updatesMapShapeWhenKeyOrValueIsUpdated() {
        ...
        assertThat(
            resultWithNewKey.getShape(keyMemberId).get().getTrait(SensitiveTrait.class),
            Matchers.not(Optional.empty())
        );
        assertThat(
            resultWithNewKey.getShape(containerId).get().asMapShape().get().getKey(),
            Matchers.is(newKeyMember)
        );

        assertThat(
            resultWithNewValue.getShape(valueMemberId).get().getTrait(SensitiveTrait.class),
            Matchers.not(Optional.empty())
        );
        assertThat(
            resultWithNewValue.getShape(containerId).get().asMapShape().get().getValue(),
    ...
    public void updatesStructureWhenMemberChanges() {
        ...
        assertThat(
            result.getShape(containerId).get().asStructureShape().get().getMember("b").get(),
    ...
    public void updatesTaggedUnionShapeWhenMemberChanges() {
        ...
        assertThat(
            result.getShape(containerId).get().asUnionShape().get().getMember("b").get(),
            Matchers.is(newMemberB)
        );
    }
    ...
    public void doesNotOverwriteOtherContainerUpdatesWhenAlsoUpdatingMembers() {
        ...
        assertThat(
            result.getShape(containerId).get().asListShape().get().getTrait(LengthTrait.class),
            Matchers.not(Optional.empty())
        );
