...
public class CreateDedicatedInputAndOutputTest {
    ...
    public void createsDedicatedInputHeuristic() {
        ...
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooInput")).getTrait(OriginalShapeIdTrait.class),
            Matchers.equalTo(Optional.empty())
        );
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooOutput")).getTrait(OriginalShapeIdTrait.class),
            Matchers.equalTo(Optional.empty())
        );
    }
    ...
    public void createsDedicatedCopies() {
        ...
        result.expectShape(ShapeId.from("smithy.example#GetFooOutput")).expectTrait(OutputTrait.class);
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooInput"))
                .expectTrait(OriginalShapeIdTrait.class)
                .getOriginalId(),
            Matchers.equalTo(ShapeId.from("smithy.example#GetFooData"))
        );
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooOutput"))
                .expectTrait(OriginalShapeIdTrait.class)
                .getOriginalId(),
    ...
    public void createsDedicatedCopiesAndDeconflicts() {
        ...
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooOperationInput"))
                .expectTrait(OriginalShapeIdTrait.class)
                .getOriginalId(),
            Matchers.equalTo(ShapeId.from("smithy.example#GetFooData"))
        );
        assertThat(
            result.expectShape(ShapeId.from("smithy.example#GetFooOperationOutput"))
                .expectTrait(OriginalShapeIdTrait.class)
                .getOriginalId(),
            Matchers.equalTo(ShapeId.from("smithy.example#Foo"))
        );
    ...
    public void removesDisconnectedSharedShape() {
        Model result = compareTransform(
            "removes-disconnected-shared-shape",
    ...
    public void createsDedicatedHeuristicForSharedShape() {
        Model result = compareTransform(
            "creates-dedicated-heuristic-for-shared",
            model -> ModelTransformer.create().createDedicatedInputAndOutput(model, "Input", "Output")
        );
