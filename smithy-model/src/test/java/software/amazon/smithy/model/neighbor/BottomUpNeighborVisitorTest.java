...
public class BottomUpNeighborVisitorTest {
    ...
    public void dataShape() {
        ...
        assertThat(
            neighborVisitor.getNeighbors(shape),
            containsInAnyOrder(
    ...
    public void structureShape() {
        ...
        assertThat(
            neighborVisitor.getNeighbors(input),
            containsInAnyOrder(
        ...
        assertThat(
            neighborVisitor.getNeighbors(output),
            containsInAnyOrder(
        ...
        assertThat(
            neighborVisitor.getNeighbors(error),
            containsInAnyOrder(
    ...
    public void resourceShape() {
        ...
        assertThat(
            neighborVisitor.getNeighbors(child2),
            containsInAnyOrder(
                Relationship.create(child1, RelationshipType.RESOURCE, child2)
            )
        );
        assertThat(
            neighborVisitor.getNeighbors(child1),
            containsInAnyOrder(
        ...
        assertThat(
            neighborVisitor.getNeighbors(resource),
            containsInAnyOrder(
    ...
    public void operationShape() {
        ...
        assertThat(
            neighborVisitor.getNeighbors(namedOperation),
            containsInAnyOrder(
