...
@annotationTrait
// Annotation trait without parens
@internal()
// Annotation trait with parens
...
// Structured trait with braces
@stringTrait("foo")
// String trait using normal string syntax
@since("""
    0.9""")
// String trait using block syntax
@numberTrait(1)
// Number trait
@boolTrait(true)
// Boolean trait
