 ...
 * list of neighbor rel filters.
 */
final class ReverseNeighborSelector extends AbstractNeighborSelector {

    ReverseNeighborSelector(List<String> relTypes) {
        super(relTypes);
    }
    ...
    NeighborProvider getNeighborProvider(Context context, boolean includeTraits) {
        return includeTraits
               ? context.neighborIndex.getReverseProviderWithTraitRelationships()
               : context.neighborIndex.getReverseProvider();
    }
