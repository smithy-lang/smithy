...
/// Marks a shape as generated by the model assembler rather than authored by a
/// model author, such as the synthetic list and map shapes created by inline
/// collection declarations.
///
/// Only the assembler may apply this trait; it must not be applied manually. A
/// shape that carries it is named using the reserved `_Synthetic` prefix. The
/// trait is serialized in the JSON AST so that AST consumers can tell generated
/// shapes apart from authored ones; it is never serialized in the IDL, where
/// the IDL 2.1 inline collection syntax carries the same information.
