...
public final class TracingSymbolProvider implements SymbolProvider {
    ...
    private TracingSymbolProvider(Builder builder) {
        ...
        traceFileBuilder.artifact(SmithyBuilder.requiredState("artifactMetadata", builder.artifactMetadata))
    ...
    public Symbol toSymbol(Shape shape) {
        ...
        if (visitedShapes.add(shapeId)) {
            ...
            if (shapeLinks.size() > 0) {
                traceFileBuilder.addShapeLinkList(shapeId, shapeLinks);
            }
        }
        return symbol;
    }
    ...
    public static final class Builder implements SmithyBuilder<TracingSymbolProvider> {
        ...
        /**
         * Sets this Builder's ArtifactMetadata.
         *
         * @param artifactMetadata ArtifactMetadata for this TracingSymbolProvider's
         *                         TraceFile.
         * @return This Builder.
         */
        ...
        /**
         * Sets the Builder's {@link ArtifactMetadata} based on the given type and
         * default values for other required fields. This method should ONLY be used
         * when the version, type, homepage, and typeVersion of the ArtifactMetadata
         * object is unknown at the time of code generation. This method will ONLY set
         * the required fields of the {@link ArtifactMetadata}.
         *
         ...
         *
         * <p>The timestamp in ArtifactMetadata is set to the current time when the
         * method is called.
         *
         ...
         *
         * @param artifactType The type, i.e. language, of the ArtifactMetadata object.
         * @return This Builder.
         */
        public Builder setArtifactMetadataAsDefault(String artifactType) {
            String tempIdVersion = UUID.randomUUID().toString();
            this.artifactMetadata = ArtifactMetadata.builder()
